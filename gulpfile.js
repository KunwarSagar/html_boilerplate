...
const build = gulp.series(
    clean.all,
    gulp.parallel(copy.copyHtml, copy.copyFonts, copy.copyFavicon, copy.copyPhp, copy.copyPhpConfig, copy.copyPhpLib, css.buildCss, css.minifyCSS, images.optimizeImages, scripts)
);
const purge = gulp.series(scripts, css.purge);
